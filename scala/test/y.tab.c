...
{
  "$end", "error", "$undefined", "TOKEN_COMMA", "TOKEN_COLON",
  "TOKEN_PERIOD", "TOKEN_SEMICOLON", "TOKEN_LEFT_PARENTHESE",
  "TOKEN_RIGHT_PARENTHESE", "TOKEN_LEFT_SQUARE_BRACKET",
  "TOKEN_RIGHT_SQUARE_BRACKET", "TOKEN_LEFT_BRACKET",
  "TOKEN_RIGHT_BRACKET", "TOKEN_ADD", "TOKEN_SUB", "TOKEN_MUL",
  "TOKEN_DIV", "TOKEN_LT", "TOKEN_LTE", "TOKEN_GTE", "TOKEN_GT",
  "TOKEN_EQ", "TOKEN_NEQ", "TOKEN_LOGICAL_AND", "TOKEN_LOGICAL_OR",
  "TOKEN_LOGICAL_NOT", "TOKEN_MOD", "TOKEN_ASSIGN", "TOKEN_ASSIGN_ADD",
  "TOKEN_ASSIGN_SUB", "TOKEN_ASSIGN_MUL", "TOKEN_ASSIGN_DIV",
  "TOKEN_ASSIGN_MOD", "TOKEN_BOOLEAN", "TOKEN_BREAK", "TOKEN_CHAR",
  "TOKEN_CASE", "TOKEN_CLASS", "TOKEN_CONTINUE", "TOKEN_DEF", "TOKEN_DO",
  "TOKEN_ELSE", "TOKEN_EXIT", "TOKEN_FLOAT", "TOKEN_FOR", "TOKEN_IF",
  "TOKEN_INT", "TOKEN_NULL", "TOKEN_OBJECT", "TOKEN_PRINT",
  "TOKEN_PRINTLN", "TOKEN_REPEAT", "TOKEN_RETURN", "TOKEN_STRING",
  "TOKEN_TO", "TOKEN_TYPE", "TOKEN_VAL", "TOKEN_VAR", "TOKEN_WHILE",
  "TOKEN_TRUE", "TOKEN_FALSE", "TOKEN_ID", "TOKEN_CONSTANT_INT",
  "TOKEN_CONSTANT_REAL", "TOKEN_CONSTANT_STRING", "UMINUS", "'='",
  "$accept", "statement", "expr", "number", YY_NULLPTR
};
#endif
...
{
      10,     6,    11,    12,     1,     2,     8,     9,     7,     2
};

static const yytype_uint8 yycheck[] =
{
       6,    66,     8,     9,    61,    62,    13,    14,     0,    62
};
...
#line 72 "parser.y" /* yacc.c:1646  */
    {insert((yyvsp[-2].string), (yyvsp[0].integer));dump();cout << (yyval.integer) << " statement" << endl;}
#line 1365 "y.tab.c" /* yacc.c:1646  */
    break;

  case 3:
#line 73 "parser.y" /* yacc.c:1646  */
    {(yyval.integer)=(yyvsp[0].integer);cout << (yyval.integer) << endl;}
...
#line 77 "parser.y" /* yacc.c:1646  */
    {(yyval.integer)=(yyvsp[0].integer);cout << (yyvsp[0].integer) << " exp" << endl;}
#line 1389 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 79 "parser.y" /* yacc.c:1646  */
    {(yyval.integer)=(yyvsp[0].integer);cout << (yyvsp[0].integer) << " num" << endl;}
