...
static const char *const yytname[] =
{
  ...
  "TOKEN_CONSTANT_REAL", "TOKEN_CONSTANT_STRING", "UMINUS", "$accept",
  "statement", "expr", "constants", YY_NULLPTR
};
#endif
